...
M201 X1200 Y1200 Z250 E9000     ; Set accelerations (mm/s^2)
M906 X700 Y1200 Z650 E650 I30   ; Set motor currents (mA) and motor idle factor in per cent
...
M591 D0 P2 C2 S1                  ; Filament Sensor

; Z-Probe
M574 Z1 S2                     ; Set endstops controlled by probe
M558 P5 I1 H5 F300 T6000          ; Set Z probe type to ultrasonic and the dive height + speeds
G31 P500 X3 Y-23 Z1.70        ; Set Z probe trigger value, offset and trigger height
